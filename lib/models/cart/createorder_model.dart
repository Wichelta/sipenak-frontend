...
//
//     final createOrderIdModel = createOrderIdModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

CreateOrderIdModel createOrderIdModelFromJson(String str) =>
    CreateOrderIdModel.fromJson(json.decode(str));

String createOrderIdModelToJson(CreateOrderIdModel data) =>
...
class CreateOrderIdModel {
  ...
  factory CreateOrderIdModel.fromJson(Map<String, dynamic> json) =>
      CreateOrderIdModel(
